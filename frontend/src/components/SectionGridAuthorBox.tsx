import CardAuthorBox from 'frontend/src/components/CardAuthorBox'
import CardAuthorBox2 from 'frontend/src/components/CardAuthorBox2'
import { TAuthor } from 'frontend/src/data/authors'
