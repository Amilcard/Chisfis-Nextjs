...
import { getCurrencies, getLanguages, getNavMegaMenu } from 'frontend/src/data/navigation'
import { Button } from 'frontend/src/shared/Button'
import Logo from 'frontend/src/shared/Logo'
import clsx from 'clsx'
import { FC, useState, useEffect } from 'react'
import AvatarDropdown from './AvatarDropdown'
import CategoriesDropdown from './CategoriesDropdown'
// import CurrLangDropdown from './CurrLangDropdown'  // Non copié
import HamburgerBtnMenu from './HamburgerBtnMenu'
// import MegaMenuPopover from './MegaMenuPopover'    // Non copié
