      ...
      >
        <div>
            ...
            {solutions.map((item, index) => {
              ...
              return (
                <CloseButton
                  ...
                  key={index}
                  href={item.href}
                  className={`focus-visible:ring-opacity-50 -m-3 flex items-center rounded-lg p-2 focus:outline-none focus-visible:ring focus-visible:ring-brand-green ${
          ...
          <div className="bg-neutral-50 p-4 dark:bg-neutral-700">
            <Link
              href="/"
              className="focus-visible:ring-opacity-50 flow-root space-y-0.5 rounded-md px-2 py-2 focus:outline-none focus-visible:ring focus-visible:ring-brand-green"
            >
